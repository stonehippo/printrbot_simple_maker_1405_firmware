 ...
 */
  ...
  #define INVERT_X2_VS_X_DIR true     // X2 direction signal is the opposite of X
  ...
  #define INVERT_Y2_VS_Y_DIR true     // Y2 direction signal is the opposite of Y
...
#define DAC_MOTOR_CURRENT_DEFAULT {70,70,65,70}           // Default drive percent - X, Y, Z, E axis
